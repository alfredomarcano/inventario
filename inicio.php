	...
	<h1>Sistema de Inventarios gfasvdnsajdndsaj</h1>
            ...
            <ul class="flex-container">
                <li class="flex-item menu1">
                    <i class="fas fa-desktop icon1"></i>
                    <p>Escritorio</p>
                </li>
                <li class="flex-item menu2">
                    <i class="fas fa-laptop"></i>
                    <p>Laptos</p>
                </li>
                <li class="flex-item menu3">
                    <i class="fas fa-ambulance"></i>
                    <p>Mantenimeinto</p>
                </li>
                <li class="flex-item menu4">
